...
describe("PersonalSchedulesIndexPage tests", () => {
    ...
    test("renders three schedules without crashing for regular user", async () => {
        setupUserOnly();
        const queryClient = new QueryClient();
        axiosMock.onGet("/api/personalschedules/all").reply(200, personalSchedulesFixtures.twoPersonalSchedules);
